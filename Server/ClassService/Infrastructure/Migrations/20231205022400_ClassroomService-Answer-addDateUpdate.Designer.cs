...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231205022400_ClassroomService-Answer-addDateUpdate")]
    partial class ClassroomServiceAnsweraddDateUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Answer", b =>
                {
                    ...
                    b.Property<DateTime>("DateAnswer")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 24, 0, 305, DateTimeKind.Local).AddTicks(6907));
            ...
            modelBuilder.Entity("Domain.Entities.Classroom", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 24, 0, 302, DateTimeKind.Local).AddTicks(2164));
            ...
            modelBuilder.Entity("Domain.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 24, 0, 305, DateTimeKind.Local).AddTicks(5641));
            ...
            modelBuilder.Entity("Domain.Entities.LearningDocument", b =>
                {
                    ...
                    b.Property<DateTime>("UploadDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 24, 0, 305, DateTimeKind.Local).AddTicks(8480));
            ...
            modelBuilder.Entity("Domain.Entities.NotifyClassroom", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 24, 0, 305, DateTimeKind.Local).AddTicks(9570));
