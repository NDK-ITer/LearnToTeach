...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231205020950_ClassroomService-table-LearningDocument-addColumn-UploadDate")]
    partial class ClassroomServicetableLearningDocumentaddColumnUploadDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Answer", b =>
                {
                    ...
                    b.Property<DateTime>("DateAnswer")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 9, 50, 176, DateTimeKind.Local).AddTicks(5229));
            ...
            modelBuilder.Entity("Domain.Entities.Classroom", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 9, 50, 172, DateTimeKind.Local).AddTicks(9894));
            ...
            modelBuilder.Entity("Domain.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 9, 50, 176, DateTimeKind.Local).AddTicks(3946));
            ...
            modelBuilder.Entity("Domain.Entities.LearningDocument", b =>
                {
                    ...
                    b.Property<DateTime>("UploadDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 9, 50, 176, DateTimeKind.Local).AddTicks(6816));
            ...
            modelBuilder.Entity("Domain.Entities.NotifyClassroom", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 5, 9, 9, 50, 176, DateTimeKind.Local).AddTicks(8159));
