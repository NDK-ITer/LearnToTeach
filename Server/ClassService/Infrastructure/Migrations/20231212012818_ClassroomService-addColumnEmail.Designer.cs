...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231212012818_ClassroomService-addColumnEmail")]
    partial class ClassroomServiceaddColumnEmail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Answer", b =>
                {
                    ...
                    b.Property<DateTime>("DateAnswer")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 12, 8, 28, 18, 900, DateTimeKind.Local).AddTicks(282));
            ...
            modelBuilder.Entity("Domain.Entities.Classroom", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 12, 8, 28, 18, 896, DateTimeKind.Local).AddTicks(6159));
            ...
            modelBuilder.Entity("Domain.Entities.Exercise", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 12, 8, 28, 18, 899, DateTimeKind.Local).AddTicks(9021));
            ...
            modelBuilder.Entity("Domain.Entities.LearningDocument", b =>
                {
                    ...
                    b.Property<DateTime>("UploadDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 12, 8, 28, 18, 900, DateTimeKind.Local).AddTicks(1688));
            ...
            modelBuilder.Entity("Domain.Entities.NotifyClassroom", b =>
                {
                    ...
                    b.Property<DateTime?>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 12, 8, 28, 18, 900, DateTimeKind.Local).AddTicks(2724));
